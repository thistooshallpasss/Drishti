...
UPDATE drishti_links SET master_tile_id = 'tools' WHERE master_tile_id IS NULL AND master_tile_id IS NULL;

-- 4. Ensure supabase_realtime publishes drishti_settings changes
-- (Run if you get "Realtime channel TIMED_OUT" errors)
